...
function renderFavorites(favorites) {
  ...
  container.innerHTML = favorites.map((name, index) => {
    ...
    const imgHtml = pokemon?.image
      ? `<img src="${escapeHtml(getFixedPokemonImage(pokemon))}" alt="${escapeHtml(pokemon.name)}" onload="this.style.display='block'; this.nextElementSibling.style.display='none';" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline';">`
      : "";
